	...
	public function _rules()
		{
			...
			$this->form_validation->set_rules('sks','sks','required',['required' => 'Nama SKS Wajib Diisi !']);
			$this->form_validation->set_rules('semester','semester','required',['required' => 'Nama semester Wajib Diisi !']);
