<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
      ...
      <p>Selamat Datang <strong><?php echo $username ?></strong> di Sistem Informasi Akademik Universitas Wahyuno TV, Anda login sebagai <strong><?php echo $level ?></strong></p>
      <hr>
