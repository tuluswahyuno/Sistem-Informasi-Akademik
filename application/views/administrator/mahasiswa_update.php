<div class="container-fluid">
		...
		<div class="form-group">
			...
			<input type="text" name="tanggal_lahir" class="form-control datepicker" value="<?php echo $mhs->tanggal_lahir ?>">
		...
		<div class="form-group">
			...
			<?php endforeach; ?><br>
			<label>Foto</label><br>
			<input type="file" name="photo" value="<?php echo $mhs->photo ?>">
		</div>

		<button type="submit" class="btn btn-primary mb-5">Simpan</button>

		<td width="20px"> <?php echo anchor('administrator/mahasiswa','<div class="btn btn-info mb-5">Kembali</div>') ?></td>



		<!-- <td width="20px"> <?php echo anchor('administrator/mahasiswa/detail/'.$mhs->id,'<div class="btn btn-info mb-5">Kembali</div>') ?></td> -->
